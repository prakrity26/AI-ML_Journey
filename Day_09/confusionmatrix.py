...
# Plot
plt.plot(fpr, tpr, color="steelblue", label=f"AUC = {auc_score:.2f}")
plt.plot([0,1], [0,1], color="salmon", linestyle="--", label="Random model")
